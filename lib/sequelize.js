...
class Sequelize {
   ...
   * @param {String}   [options.dialect] The dialect of the database you are connecting to. One of mysql, postgres, sqlite, mssql and openedge.
  ...
  constructor(database, username, password, options) {
    ...
    switch (this.getDialect()) {
      ...
      case 'sqlite':
        ...
        break;
      case 'openedge':
        Dialect = require('./dialects/openedge');
        break;
      default:
        throw new Error('The dialect ' + this.getDialect() + ' is not supported. Supported dialects: mssql, mysql, postgres, sqlite, and openedge.');
    }
